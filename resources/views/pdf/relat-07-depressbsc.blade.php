        ...
        @foreach ($dadosRelatorio['resultadoTeste'] as $item)
            @php
                ...
                $subHeading = match ($item->sequencia) {
                    1 => 'Componentes Relacionados aos Distúrbios da Afetividade - depressão no humor / afeto:',
                    94 => 'Componentes Relacionados com Obsessão e Compulsividade:',
                    104 => 'Componentes depressivos relacionados com a noção do juízo/ julgamento e tomada de decisão:',
                    default => '',
                };
            @endphp
