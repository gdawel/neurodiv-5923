...
<div class="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/squared-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/squared-bg-element.svg')] before:bg-no-repeat before:bg-top before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-10">
    ...
    <div class="mt-5 max-w-xl text-center mx-auto">
      <h1 class="block font-bold text-gray-800 text-2xl md:text-3xl lg:text-3xl dark:text-neutral-200">
        {{-- Neurodiversidade <br>+ <br>Resiliência <br>=<br> Produtividade --}}
        Testes de triagens para você identificar suas características neurodivergentes
    ...
    <div class="mt-5 max-w-3xl text-center mx-auto">
      <p class="text-lg text-gray-600 dark:text-neutral-400">Já sentiu que pensa e vivencia o mundo de uma forma um pouco diferente? Nossos testes sobre neurodivergência foram elaborados para ajudar você a explorar o espectro da neurodiversidade e obter insights sobre seu perfil cognitivo único.
      </p>
    </div>
...
<div class=" bg-white max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="max-w-2xl mx-auto text-center mb-6 lg:mb-10">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Escolha um grupo de testes</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
      ...
      <div>
        ...
        <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ff0] font-medium text-sm text-neutral-800 rounded-full focus:outline-none" 
            href="https://wa.me/5511987727946" target="_blank">
